/*
	...
	- Changed on 02/04/13: fixed flag in ofstream that caused bug under Windows, 
...
void render(const std::vector<Sphere<T> *> &spheres)
{
	...
	std::ofstream ofs("./output/untitled.ppm", std::ios::out | std::ios::binary);
	ofs << "P6\n" << width << " " << height << "\n255\n";
